-- Add markup_opened_at to the get_plans projection so the admin plans
-- table can show an indicator on rows where the practice has viewed
-- the markup file but not yet acted.
