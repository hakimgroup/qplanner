-- get_plans (drafts variant)
-- Changes:
--   1. Hide 'draft' rows from admin/super_admin viewers — drafts are practice-only.
--   2. Include 'draft' alongside 'onPlan' for the assets/creatives template branches
--      (drafts have no submitted choices yet; show catalog/bespoke template).
--   3. Add a 'draft' count to the meta object.
