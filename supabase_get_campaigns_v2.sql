-- get_campaigns v2: Add creatives column to the response
-- This adds c.creatives from campaigns_catalog to the RETURNS TABLE and SELECT
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.get_campaigns(uuid) TO anon, authenticated, service_role;
