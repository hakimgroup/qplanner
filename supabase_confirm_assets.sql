-- ============================================================
-- RPC Function: confirm_assets
-- Called by practice users to confirm/approve assets
-- Transitions selection from 'awaitingApproval' -> 'confirmed'
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.confirm_assets(UUID, TEXT) TO authenticated;
