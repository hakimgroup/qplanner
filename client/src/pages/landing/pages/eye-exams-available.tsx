/**
 * Route stub for Eye Exams Available, always on.
 *
 * The page itself lives in `_uypp-q4/pages/eye-exams-available.tsx`, with the rest of the Q4
 ...
 */
export { default, meta } from "./_uypp-q4/pages/eye-exams-available";
