/**
 * Route stub for the Q4 hub.
 *
 * The page itself lives in `_uypp-q4/pages/q4-campaigns.tsx`, with the rest of the Q4
 ...
 */
export { default, meta } from "./_uypp-q4/pages/q4-campaigns";
