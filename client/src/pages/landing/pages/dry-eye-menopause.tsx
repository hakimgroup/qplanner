/**
 * Route stub for Dry Eye & Menopause, October.
 *
 * The page itself lives in `_uypp-q4/pages/dry-eye-menopause.tsx`, with the rest of the Q4
 ...
 */
export { default, meta } from "./_uypp-q4/pages/dry-eye-menopause";
