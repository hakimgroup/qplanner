/**
 * Route stub for Festive Windows, December.
 *
 * The page itself lives in `_uypp-q4/pages/festive-windows.tsx`, with the rest of the Q4
 ...
 */
export { default, meta } from "./_uypp-q4/pages/festive-windows";
