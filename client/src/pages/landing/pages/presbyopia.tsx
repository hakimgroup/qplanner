/**
 * Route stub for Presbyopia, October.
 *
 * The page itself lives in `_uypp-q4/pages/presbyopia.tsx`, with the rest of the Q4
 ...
 */
export { default, meta } from "./_uypp-q4/pages/presbyopia";
