/**
 * Route stub for Black Friday, November.
 *
 * The page itself lives in `_uypp-q4/pages/black-friday.tsx`, with the rest of the Q4
 ...
 */
export { default, meta } from "./_uypp-q4/pages/black-friday";
